...
${TESTDIR}/tests/instSiTest.o: tests/instSiTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/instSiTest.o tests/instSiTest.cpp


${TESTDIR}/tests/instSiTestrunner2.o: tests/instSiTestrunner2.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/instSiTestrunner2.o tests/instSiTestrunner2.cpp
